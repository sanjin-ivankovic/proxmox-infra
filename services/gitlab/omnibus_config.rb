...
#
# GitLab serves the canonical source.example.com. The compose port map is 2222:22
...
nginx['real_ip_trusted_addresses'] = ['10.10.0.0/24', '10.244.0.0/16', '10.96.0.0/12']
...
# Container registry is handled by Harbor (registry.example.com), not GitLab.
