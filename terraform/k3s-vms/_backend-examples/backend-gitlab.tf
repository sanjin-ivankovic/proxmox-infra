...
terraform {
  backend "http" {
    address        = "https://gitlab.example.com/api/v4/projects/1/terraform/state/k3s-vms"
    lock_address   = "https://gitlab.example.com/api/v4/projects/1/terraform/state/k3s-vms/lock"
    unlock_address = "https://gitlab.example.com/api/v4/projects/1/terraform/state/k3s-vms/lock"
    lock_method    = "POST"
