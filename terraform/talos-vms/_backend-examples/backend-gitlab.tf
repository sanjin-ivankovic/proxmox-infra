...
#   export TF_STATE_NAME=talos-vms
#   terraform init \
...
terraform {
  backend "http" {
    address        = "https://gitlab.example.com/api/v4/projects/1/terraform/state/talos-vms"
    lock_address   = "https://gitlab.example.com/api/v4/projects/1/terraform/state/talos-vms/lock"
    unlock_address = "https://gitlab.example.com/api/v4/projects/1/terraform/state/talos-vms/lock"
    lock_method    = "POST"
