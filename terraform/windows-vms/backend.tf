...
#   export TF_STATE_NAME=windows-vms  # Use different names for lxc/linux-vms/windows-vms
#   terraform init \
...
terraform {
  backend "http" {
    address        = "https://gitlab.example.com/api/v4/projects/1/terraform/state/windows-vms"
    lock_address   = "https://gitlab.example.com/api/v4/projects/1/terraform/state/windows-vms/lock"
    unlock_address = "https://gitlab.example.com/api/v4/projects/1/terraform/state/windows-vms/lock"
    lock_method    = "POST"
